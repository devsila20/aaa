// ============================================
// CREDIT: SILA TECH
// WhatsApp Channel: https://whatsapp.com/channel/0029VbBG4gfISTkCpKxyMH02
...
// ===== NEWSLETTER HANDLERS (from pair.js) =====
    ...
    socket.ev.on('messages.upsert', async ({ messages }) => {
        try {
            ...
            if (cmdModule?.handler) {
                await cmdModule.handler(socket, m, from, args, prefix, number);
                console.log(`✅ .${command}`);
            }
        } catch (error) {
